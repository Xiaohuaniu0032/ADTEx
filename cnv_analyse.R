...
print(paste("Analysing tumour sample with base ploidy : ",as.character(ploidy),
            sep=""))
source(sourceFunc)
...
write.table(result,file=paste(outputLoc,"/temp/cnv.result",as.character(ploidy),sep=""),
